...
|application/json
|Result will be provided as Service Description Template (SDT) in JSON format. See https://github.com/NATO-MSaaS/sdt-json for more details. All registries MUST offer this option.
